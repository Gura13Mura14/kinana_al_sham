...
class AppPages {
  static final routes = [
    ...
    GetPage(name: '/CertificateCard', page: () => CertificateCard(volunteerName: 'Ahmad',eventName: 'Saly',issuedAt: 'jj',)),
    ...
    //  GetPage(name: '/update-profile',page: () => UpdateProfileView(),),
    GetPage(
      name: '/emergency_requests',
      page: () => VolunteerEmergencyRequestsView(),
    ),
    GetPage(
      name: '/beni_emergency_requests',
      page: () => BeniEmergencyRequestsView(),
    ),
    GetPage(
