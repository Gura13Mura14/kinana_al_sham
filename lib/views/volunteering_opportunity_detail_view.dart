              ...
              children: [
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: Colors.white.withOpacity(0.95),  // خلفية بيضاء شبه شفافة للنصوص
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            const SizedBox(width: 6),
                            Text("عن بعد: ${opportunity.isRemote ? 'نعم' : 'لا'}"),
                          ],
                        ),
                        ...
                        Row(
                          children: [
                            Icon(Icons.calendar_month, color: AppColors.bluishGray),
                            const SizedBox(width: 6),
                        ...
                        Row(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Icon(Icons.description_outlined, color: AppColors.bluishGray),
                            const SizedBox(width: 6),
                            Expanded(
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                        ...
                        Row(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Icon(Icons.assignment_turned_in_outlined, color: AppColors.bluishGray),
                            const SizedBox(width: 6),
                            Expanded(
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
